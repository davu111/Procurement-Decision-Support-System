...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className={cn("flex items-center gap-3", expanded ? "px-2 mb-6" : "")}>
      ...
      <nav className={cn("flex flex-col gap-1 flex-1 w-full", expanded ? "" : "items-center")}>
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={cn(
                ...
                expanded ? "w-full px-3 py-2.5 rounded-xl gap-3" : "w-10 h-10 rounded-xl justify-center",
                active
      ...
      {/* Bottom actions */}
      <div className={cn("flex flex-col gap-2 w-full mt-auto", expanded ? "" : "items-center")}>
        <button
