  ...
  const nextModel =
    dataPoints >= 18
      ...
      : dataPoints >= 6
        ...
        : "Holt-Winters";
  const pointsNeeded =
    dataPoints >= 18 ? 0 : dataPoints >= 6 ? 18 - dataPoints : 6 - dataPoints;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setPlannedConsumption(e.target.value)}
              required
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setActualSupplyRate(e.target.value)}
              placeholder="VD: 170"
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="VD: Tháng Tết, tiêu thụ tăng cao..."
          />
        </div>
